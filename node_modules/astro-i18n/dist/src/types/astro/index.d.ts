...
export declare type AstroHooks = {
    ...
    "build:generated": NonNullable<AstroIntegration["hooks"]["astro:build:generated"]>;
...
export declare type GetStaticPathsProps = {
    paginate: Function;
    rss: Function;
};
